...
Non posso definirlo con il metodo ``aggiungi un attributo'' ogni volta, perché altrimenti ho da perderci e basta. Allora, per definirli, li inserisco nel \textbf{costruttore della classe}. È un metodo speciale chiamato ad ogni istanza, e in python si chiama \mintinline{python}{__init__}. Fa parte dei metodi speciali (o \textit{dunder methods}) circondati dai caratteri \texttt{\_\_}.
...
E per chiamare le properties, non servono le parentesi, cioè scrivo \mintinline{python}{v.attribute} invece di \mintinline{python}{v.attribute()}.
...
% todo aggiungi il codice per capire che sta a succedere
...
% todo finisci qua le cose di codice, mentre la parte di ottimizzazione mi sembra banale
